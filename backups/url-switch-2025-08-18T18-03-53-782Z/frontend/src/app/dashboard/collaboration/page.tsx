...
export default function CollaborationPage() {
  ...
  const fetchMyRequests = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/collaboration-requests/my`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSearchStudent = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/students/search-for-collaboration?ministryCode=${searchMinistryCode}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const checkCollaborationAccess = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration-requests/access/${selectedStudent._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchCollaborationData = async () => {
    ...
    try {
      ...
      const notesResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/notes/student/${selectedStudent._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      ...
      const appointmentsResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/appointments?studentId=${selectedStudent._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
      ...
      const reportsResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/progress-reports/student/${selectedStudent._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleCreateRequest = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration-requests`,
        {
  ...
  const handleCreateNote = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/notes`,
        {
          content: noteContent,
          studentId: selectedStudent._id
        },
  ...
  const handleCreateAppointment = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/appointments`,
        {
          ...appointmentForm,
          studentId: selectedStudent._id
        },
  ...
  const handleCreateReport = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/collaboration/progress-reports`,
        {
          ...reportForm,
          studentId: selectedStudent._id
        },
