...
export default function CourseAccessManagementPage() {
  ...
  const loadRequests = async () => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:8080/api/course-access/all`,
  ...
  const handleApprove = async (requestId: string) => {
    ...
    try {
      await axios.put(
        `http://localhost:8080/api/course-access/${requestId}/approve`,
  ...
  const handleReject = async (requestId: string) => {
    ...
    try {
      await axios.put(
        `http://localhost:8080/api/course-access/${requestId}/reject`,
